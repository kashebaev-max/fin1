    ...
    <div style={{ background: "var(--bg)", color: "var(--t1)", minHeight: "100vh" }}>
      ...
      <section id="ocr" className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full" style={{ background: "#A855F715", border: "1px solid #A855F730" }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#A855F7", letterSpacing: "0.05em" }}>📸 НОВОЕ • AI VISION</span>
          </div>
        </div>
        ...
        {/* Сравнение времени */}
        <div className="rounded-2xl p-8 mb-10" style={{ background: "linear-gradient(135deg, #A855F710, #6366F110)", border: "1px solid #A855F730" }}>
          <div className="text-center text-xs font-bold tracking-widest mb-6" style={{ color: "#A855F7" }}>✦ ЭКОНОМИЯ ВРЕМЕНИ</div>
          ...
          <div className="text-center mt-6">
            <div className="text-sm font-bold" style={{ background: "linear-gradient(135deg, #6366F1, #A855F7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
      ...
      <section id="hr" className="max-w-6xl mx-auto px-6 py-16">
        {/* Badge */}
        <div className="text-center mb-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full" style={{ background: "#10B98115", border: "1px solid #10B98140" }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#10B981", letterSpacing: "0.05em" }}>👥 КАДРЫ + ЗП</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {/* Табель */}
          <div className="rounded-xl p-6" style={{ background: "var(--card)", border: "1px solid var(--brd)", borderTop: "3px solid #6366F1" }}>
          ...
          {/* Отпуска */}
          <div className="rounded-xl p-6" style={{ background: "var(--card)", border: "1px solid var(--brd)", borderTop: "3px solid #A855F7" }}>
            <div className="text-3xl mb-3">🏖</div>
        ...
        <div className="rounded-2xl p-8" style={{ background: "linear-gradient(135deg, #10B98110, #06B6D410)", border: "1px solid #10B98140" }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-2 flex-wrap">
                {[
                  { icon: "⏰", label: "Табель", color: "#6366F1" },
                  { icon: "→", label: "", color: "var(--t3)" },
                  { icon: "💰", label: "ЗП", color: "#A855F7" },
                  { icon: "→", label: "", color: "var(--t3)" },
