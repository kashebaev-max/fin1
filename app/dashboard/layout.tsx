...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  function toggleTheme() {
    ...
    if (typeof window !== "undefined") {
      window.localStorage.setItem("finerp-theme", next);
    }
  }
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "var(--bg)", color: "var(--t1)", transition: "background 0.3s, color 0.3s" }}>
      ...
      <aside className="flex flex-col flex-shrink-0 transition-all duration-300"
        style={{ width: collapsed ? 56 : 220, background: "var(--sidebar)", borderRight: "1px solid var(--brd)", transition: "width 0.3s, background 0.3s" }}>
              ...
              <div key={mod.key}>
                ...
                <button onClick={() => router.push(mod.path)}
                  ...
                  style={{
                    ...
                    background: active ? (mod.adminOnly ? "#F59E0B20" : "var(--accent-dim)") : "transparent",
                    color: active ? (mod.adminOnly ? "#F59E0B" : "var(--accent)") : "var(--t3)",
        ...
        <div style={{ borderTop: "1px solid var(--brd)" }}>
          ...
          <div className="flex items-center justify-center" style={{ padding: collapsed ? "8px" : "8px 12px" }}>
            <button onClick={toggleTheme}
              className="flex items-center gap-2 rounded-lg border-none cursor-pointer w-full justify-center"
              style={{
                padding: "6px 10px",
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col overflow-hidden" style={{ transition: "background 0.3s" }}>
